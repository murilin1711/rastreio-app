...
| C-010 | PA: limiares para "medidas repetidamente elevadas" e "valor muito elevado" | — (em discussão 16/09/2026) | DBHA **2025** (substitui 2020) / Medidas PA 2023 | — | — |
| C-011 | MRPA: nº de dias do protocolo e critérios de validade | — | Medidas PA 2023, Parte 4 (substitui a 4ª Diretriz MRPA 2018) | — | — |
