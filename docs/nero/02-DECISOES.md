...
| C-008 | Próstata: decisão compartilhada | **Corrigido após leitura da SBU:** convite à conversa com o médico a partir de **50 anos**, ou **45 anos** se **histórico familiar, obesidade (IMC ≥ 30) ou raça negra** (a SBU lista os três; eu havia omitido obesidade). Texto educativo apresenta a posição do INCA/MS (não rastreamento populacional). Sem ponto de corte único de PSA; fora da referência do laboratório → "avaliação médica recomendada" (§49). | SBU, Novembro Azul 2025 · INCA/MS Nota Técnica 2023 | 2025 / 2023 | 15/09/2026 ✔ |
