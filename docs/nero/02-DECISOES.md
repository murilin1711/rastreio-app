...
| C-008 | Próstata: decisão compartilhada | **Validado nas notas oficiais da SBU (2018 e 2020) + campanha 2025.** "Homens a partir de 50 anos, mesmo sem sintomas, devem procurar um profissional especializado"; **45 anos** se raça negra ou parente de 1º grau com câncer de próstata (notas oficiais); a campanha Novembro Azul 2025 acrescenta **obesidade** — adotado, citado como fonte secundária. "Após os 75 anos, somente homens com perspectiva de vida maior do que 10 anos" → status "acompanhamento médico". Rastreamento "após ampla discussão de riscos e benefícios, em decisão compartilhada". **Periodicidade: a SBU fala em "avaliações periódicas" sem fixar intervalo → o app NÃO cria data automática; ao registrar PSA pergunta "quando seu médico pediu para repetir?" (§49: data personalizada) e o status fica "acompanhamento médico".** PSA acima da referência do laboratório → "avaliação médica recomendada" (§49); nunca um ponto de corte único. Texto educativo apresenta a posição do INCA/MS (não rastreamento populacional). | SBU — Nota Oficial 2018; Aconselhamento para o Diagnóstico Precoce (20/10/2020); Novembro Azul 2025 · INCA/MS Nota Técnica 2023 | 2018–2025 | 15/09/2026 ✔ |
