...
export const TEXTO_AGUA = {
  ...
  restricao: 'Você marcou doença renal ou insuficiência cardíaca no seu perfil. Nesses casos a quantidade de líquido faz parte do tratamento e quem define é o seu médico, e por isso o app não calcula uma meta para você. Registre o quanto bebeu e leve para a consulta.',
  ...
  metaBatida: {
    ...
    incentivo: 'Manter isso nos próximos dias é o que faz diferença. Em dias de calor ou de atividade física você precisa de mais. Se sentir sede, beba, mesmo depois de bater a meta.',
  },
} as const;
