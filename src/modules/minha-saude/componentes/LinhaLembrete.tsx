...
export const ICONE: Record<TipoLembrete, keyof typeof Ionicons.glyphMap> = { exame: 'shield-checkmark-outline', mrpa: 'pulse-outline', glicemia: 'water-outline', medicacao: 'medkit-outline', consulta: 'calendar-outline', atualizacao: 'refresh-outline', agua: 'water-outline' };
