...
const colunas: Record<CampoDominio, keyof Update> = {
  ...
  jaTeveAtividadeSexual: 'ja_teve_atividade_sexual',
  racaCor: 'raca_cor',
  menopausa: 'menopausa',
  ...
  perfilMetaGlicemica: 'perfil_meta_glicemica',
  metasGlicemia: 'metas_glicemia',
...
export function paraDominio(r: Row): PerfilSaude {
  return {
    ...
    jaTeveAtividadeSexual: r.ja_teve_atividade_sexual,
    racaCor: r.raca_cor as PerfilSaude['racaCor'],
    menopausa: r.menopausa,
    tipoDiabetes: r.tipo_diabetes as PerfilSaude['tipoDiabetes'],
    usaInsulina: r.usa_insulina as PerfilSaude['usaInsulina'],
    eventoCvPrevio: r.evento_cv_previo,
    perfilMetaGlicemica: (r.perfil_meta_glicemica as PerfilSaude['perfilMetaGlicemica']) ?? 'adulto',
    metasGlicemia: (r.metas_glicemia as PerfilSaude['metasGlicemia']) ?? null,
