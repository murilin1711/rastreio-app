...
select is(
  (select count(*) from public.perfil_saude where user_id in ('00000000-0000-0000-0000-00000000000a','00000000-0000-0000-0000-00000000000b')),
  2::bigint, 'trigger cria perfil ao inserir usuário');
...
select is((select count(*) from public.perfil_saude), 1::bigint, 'A vê só o próprio perfil (independe de quantos usuários existam)');
